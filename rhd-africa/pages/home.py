...
def render():
    ...
    features = [
        ...
        ("⚕️", "Risk Calculator", "Evidence-based Bayesian risk score combining clinical, demographic, and socioeconomic risk factors.", DARK["yellow"]),
        ("🛣️", "Roadmap", "Phase I–V research and implementation roadmap for pan-African RHD elimination.", DARK["accent"]),
    ]
    for col, (icon, title, desc, color) in zip([fc1, fc2, fc3, fc4], features):
        with col:
            st.markdown(
